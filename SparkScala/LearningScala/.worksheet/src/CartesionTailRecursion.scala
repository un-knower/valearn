object CartesionTailRecursion {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(75); 
  ...
  Multi(a, b);System.out.println("""res0: List[Int] = """ + $show(res$0));$skip(92); 
  ...
  def sumTail(a: Stream[Int]): Int = {
    ...
    loop(a, 0)
  };System.out.println("""sumTail: (a: Stream[Int])Int""");$skip(39); 

  println(sum((1 to 1000).toStream));$skip(46); 

  println(sumTail((1 to 1000000).toStream))}
