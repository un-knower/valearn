object FunProg1Week2Assignment_FuncSet {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(84); 
  println("Welcome to the Scala worksheet")
  /**
   * We represent a set by its characteristic function, i.e.
   * its `contains` predicate.
   */
  type Set = Int => Boolean;$skip(254); 

  /**
   * Indicates whether a set contains a given element.
   */
  def contains(s: Set, elem: Int): Boolean = s(elem);System.out.println("""contains: (s: FunProg1Week2Assignment_FuncSet.Set, elem: Int)Boolean""");$skip(396); 
   ...
   */
  def singletonSet(elem: Int): Set = { x => x == elem };System.out.println("""singletonSet: (elem: Int)FunProg1Week2Assignment_FuncSet.Set""");$skip(36); 

  val set1: Set = singletonSet(1);System.out.println("""set1  : FunProg1Week2Assignment_FuncSet.Set = """ + $show(set1 ));$skip(22); val res$0 = 
  ...
  def union(s: Set, t: Set): Set = {
    ...
    f
  };System.out.println("""union: (s: FunProg1Week2Assignment_FuncSet.Set, t: FunProg1Week2Assignment_FuncSet.Set)FunProg1Week2Assignment_FuncSet.Set""");$skip(254); 
  ...
  def intersection(s: Set, t: Set): Set = {
    def f(elem: Int): Boolean = { contains(s, elem) && contains(t, elem) }
    f
  };System.out.println("""intersection: (s: FunProg1Week2Assignment_FuncSet.Set, t: FunProg1Week2Assignment_FuncSet.Set)FunProg1Week2Assignment_FuncSet.Set""");$skip(248); 
  ...
  def diff(s: Set, t: Set): Set = {
    def f(elem: Int): Boolean = { (contains(s, elem)) && (!contains(t, elem)) }
    f
  };System.out.println("""diff: (s: FunProg1Week2Assignment_FuncSet.Set, t: FunProg1Week2Assignment_FuncSet.Set)FunProg1Week2Assignment_FuncSet.Set""");$skip(31); 

  val set2 = singletonSet(2);System.out.println("""set2  : FunProg1Week2Assignment_FuncSet.Set = """ + $show(set2 ));$skip(25); val res$1 = 
   ...
   */
  def filter(s: Set, p: Int => Boolean): Set = { x => contains(s, x) && p(x) };System.out.println("""filter: (s: FunProg1Week2Assignment_FuncSet.Set, p: Int => Boolean)FunProg1Week2Assignment_FuncSet.Set""");$skip(87); 
  /**
  ...
  def forall(s: Set, p: Int => Boolean): Boolean = {
    ...
    inforall(-bound)
  };System.out.println("""forall: (s: FunProg1Week2Assignment_FuncSet.Set, p: Int => Boolean)Boolean""");$skip(173); 
  ...
  def exists(s: Set, p: Int => Boolean): Boolean = !forall(s, !p(_));System.out.println("""exists: (s: FunProg1Week2Assignment_FuncSet.Set, p: Int => Boolean)Boolean""");$skip(175); 
  ...
  def map(s: Set, f: Int => Int): Set = (elem) => exists(s, elem == f(_));System.out.println("""map: (s: FunProg1Week2Assignment_FuncSet.Set, f: Int => Int)FunProg1Week2Assignment_FuncSet.Set""");$skip(186); 
  ...
  def toString(s: Set): String = {
    ...
    xs.mkString("{", ",", "}")
  };System.out.println("""toString: (s: FunProg1Week2Assignment_FuncSet.Set)String""");$skip(118); 
  ...
  def printSet(s: Set) {
    println(toString(s))
  };System.out.println("""printSet: (s: FunProg1Week2Assignment_FuncSet.Set)Unit""");$skip(15); 
