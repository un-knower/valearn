object Scala_MapVsFlatMap {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(71); 
  ...
  };System.out.println("""flatMapGaurav: (a: List[String])List[Int]""");$skip(134); 
  ...
  def fn1(a: String) = List(1, 2, 3, 4);System.out.println("""fn1: (a: String)List[Int]""");$skip(61); 

  println(flatMapGaurav(List("Ramji", "Gaurav", "Nisha")));$skip(55); 
