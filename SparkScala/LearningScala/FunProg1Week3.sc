object FunProg1Week3 {
  ...
  val t1 = new NonEmpty(1, Empty, Empty) incl 2 incl 3
                                                  //> t1  : FunProg1Week3.IntSet = {.1{.2{.3.}}}
  val t2 = new NonEmpty(4, Empty, Empty) incl 5 incl 6
                                                  //> t2  : FunProg1Week3.IntSet = {.4{.5{.6.}}}

  t1 union t2                                     //> res0: FunProg1Week3.IntSet = {{{{.1.}2.}3.}4{.5{.6.}}}
...
*/
  ...
  def singleton[T](elem: T) = new Cons[T](elem, new Nil[T])
                                                  //> singleton: [T](elem: T)FunProg1Week3.Cons[T]

  singleton[Int](1)                               //> res1: FunProg1Week3.Cons[Int] = FunProg1Week3$Cons$1@6bdf28bb
  singleton[Boolean](true)                        //> res2: FunProg1Week3.Cons[Boolean] = FunProg1Week3$Cons$1@6b71769e
  singleton(1)                                    //> res3: FunProg1Week3.Cons[Int] = FunProg1Week3$Cons$1@2752f6e2
  singleton(true)                                 //> res4: FunProg1Week3.Cons[Boolean] = FunProg1Week3$Cons$1@e580929
  ...
  }                                               //> nth: [T](n: Int, xs: FunProg1Week3.List[T])T

  val list = new Cons(1, new Cons(2, new Cons(3, new Cons(4, new Nil))))
                                                  //> list  : FunProg1Week3.Cons[Int] = FunProg1Week3$Cons$1@1cd072a9

  nth(2, list)                                    //> res5: Int = 3
  nth(7, list)                                    //> java.lang.IndexOutOfBoundsException
                                                  //| 	at FunProg1Week3$.nth$1(FunProg1Week3.scala:145)
                                                  //| 	at FunProg1Week3$.$anonfun$main$1(FunProg1Week3.scala:153)
                                                  ...
                                                  //| 	at FunProg1Week3$.main(FunProg1Week3.scala:1)
                                                  //| 	at FunProg1Week3.main(FunProg1Week3.scala)
  ...
  def map[U >: T, T](a: List[T], f: T => U): List[U] = ???
