...
object ScalaPlayGround {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(160); 
  println("Welcome to the Scala worksheet");$skip(52); 
   ...
   Logger.getLogger("org").setLevel(Level.ERROR);$skip(158); 
    ...
    val ratings = lines.map(x => x.toString().split("\t")(2));System.out.println("""ratings  : org.apache.spark.rdd.RDD[String] = """ + $show(ratings ));$skip(34); 
